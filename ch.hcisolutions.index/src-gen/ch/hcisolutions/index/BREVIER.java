 ...
 *       &lt;sequence>
 *         &lt;element name="BRV" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlRootElement(name = "BREVIER")
public class BREVIER {

    @XmlElement(name = "BRV")
    protected List<BREVIER.BRV> brv;
    @XmlElement(name = "RESULT")
    protected BREVIER.RESULT result;
    ...
    /**
     * Gets the value of the brv property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the brv property.
     * 
     * <p>
     ...
     * 
     */
    public List<BREVIER.BRV> getBRV() {
        if (brv == null) {
            brv = new ArrayList<BREVIER.BRV>();
        }
        return this.brv;
    }
     ...
     *     
     */
    public BREVIER.RESULT getRESULT() {
        return result;
    }
     ...
     *     
     */
    public void setRESULT(BREVIER.RESULT value) {
        this.result = value;
    }
