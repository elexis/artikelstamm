...
rm -Rf medindex/
wget https://github.com/elexis/artikelstamm/releases/download/0.1/MedIndexDownload.jar
wget https://github.com/elexis/artikelstamm/releases/download/0.1/ArtikelstammBuilder.jar
wget https://raw.githubusercontent.com/elexis/artikelstamm/master/info.artikelstamm.model/lib/Elexis_Artikelstamm_v5.xsd
